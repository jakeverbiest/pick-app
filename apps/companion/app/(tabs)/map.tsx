...
<head>
  ...
  <style>
    ...
    /* Zoom control sits above the floating Start button, lowered closer to it.
       ...
       margin zeroed this occupies 84-174 and adoptButton's bottom must clear
       174. It currently sits at 190.
    ...
    .maplibregl-ctrl-bottom-right { margin-bottom: 84px; margin-right: 4px; }
...
const styles = StyleSheet.create({
  ...
  adoptButton: {
    ...
    // control measures 90px tall (two 44px buttons plus borders) and sits 84px
    // up, so it occupies 84-174; this button must clear 174.
    //
